...
<body>
	...
	<input type="file" name="xlfile" id="xlf" /> ... or click here to
	select a file

	<b>Advanced Demo Options:</b> Use Web Workers: (when available)
	<input type="checkbox" name="useworker"> Use
	readAsBinaryString: (when available)
	<input type="checkbox" name="userabs">
	</pre>
	<pre id="out"></pre>
	<!--<div id="htmlout"></div>-->
	<br />
